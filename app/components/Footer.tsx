      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="opacity-80 space-y-2">
            ...
            <div>WhatsApp: <a className="underline" href="https://wa.me/917989301401" target="_blank">+91 79893 01401</a></div>
        ...
        <div>
          ...
          <a className="btn-primary inline-block bg-green-700 hover:bg-green-800" href="https://wa.me/917989301401" target="_blank">
            WhatsApp Now
          </a>
        </div>
      </div>
